...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="login.jsp"><i
		...
		<%
		UserDetails user = (com.User.UserDetails) session.getAttribute("userD");
		if (user != null) {
		%>
		...
		</a> <a href="LogoutServlet.java" class="btn btn-light my-2 my-sm-0"
